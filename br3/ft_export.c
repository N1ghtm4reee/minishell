...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/09 03:32:17 by mlouati           #+#    #+#             */
/*   Updated: 2025/02/09 16:44:23 by mlouati          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char **convert_env(t_env *env)
{
    ...
    size = env_size(env);
    env_array = gc_malloc(sizeof(char *) *(size + 1));
    if(!env_array)
        return(NULL);
    i = 0;
    temp = env;
...
void change_var_value(t_env **my_env, char *str_name, char *str_value)
{
    ...
    while(temp)
    {
        ...
        {
            temp->var_value = ft_strdup_malloc(str_value);
            break;
        }
        temp = temp->next;
    }
